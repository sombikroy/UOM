sap.ui.define([
    ...
    return PropertyEditor.extend( "sr.custom.plugins.manageuom.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("sr.custom.plugins.manageuom.i18n.builder");
			this.setPluginResourceBundleName("sr.custom.plugins.manageuom.i18n.i18n");
		},
